...
class Sakinys:
    def __init__(self, tekstas = "Zen of Python"): #defaultinis tekstas #3 uzduotis
        self.tekstas = tekstas

    #Perdaryti 1 užduotį taip, kad spausdinant sakinio objektą,
    # spausdintų ne objekto adresą, o įvestą tekstą
    def __str__(self):
        return self.tekstas
